...
def main():
    """
    Main function to parse command-line arguments and start the encryption/decryption process.
    """
    parser = argparse.ArgumentParser(description="Hybrid encryption/decryption tool using symmetric and asymmetric keys.")
    ...
    parser.add_argument('--path_to_decrypt_text',
                        ...
                        help='Enter the path to the decrypted text file. (default: decrypted_text.txt)')
